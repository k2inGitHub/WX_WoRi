...
void Recommend()
{
    ...
    NSString *value = [MobClick getConfigParams:@"Recommend_adress1.5"];
...
int videoGold()
{
    ...
    NSString *value = [MobClick getConfigParams:@"glod_1.5.1"];
    if (value) {
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"Acti"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"jfq_1.5.1"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"rate"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
int shipinShow(int index)
{
    ...
    if(index == 0)
    {
        NSString *value = [MobClick getConfigParams:@"free_1.6"];
        if (value) {
            int rtn = [value intValue];
            return rtn;
        }
    ...
    if(index == 1)
    {
        NSString *value = [MobClick getConfigParams:@"shopfree_1.6"];
        if (value) {
            int rtn = [value intValue];
            return rtn;
        }
    ...
    if(index == 2)
    {
        NSString *value = [MobClick getConfigParams:@"buyfree_1.6"];
        if (value) {
            int rtn = [value intValue];
            return rtn;
        }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"gold_time"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"push_gold_mini"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"push_gold_max"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
int shipinCount()
{
    ...
    NSString *value = [MobClick getConfigParams:@"table_screen"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"activity_onoff"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"activity_0"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"sound1.0"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"chaping"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"ads_1.5.1"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"day_ads"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
{
    [MobClick updateOnlineConfig];
    NSString *value = [MobClick getConfigParams:@"day_free"];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
int um_on_off(char* eventid)
{
    ...
    NSString *value = [MobClick getConfigParams:temp];
    if (value) {
        int rtn = [value intValue];
        return rtn;
    }
...
//    int time_flag = 21;
//    
//    NSString *value0 = [MobClick getConfigParams:@"Notification"];
//    if (value0) {
