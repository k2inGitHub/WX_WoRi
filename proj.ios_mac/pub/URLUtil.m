...
+(void)launchAppleMail:(NSString*)address yy:(NSString*)code
{
    ...
    //添加主题
    [mailUrl appendFormat:@"&subject=%@反馈",[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleName"]];
    //添加邮件内容
    [mailUrl appendFormat:@"&body=<b> </b> \n\n\n\n-------以下内容请保留--------\n系统版本: %@ \n 游戏版本: %@ \n Code:%@",[[UIDevice currentDevice] systemVersion],[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleVersion"],code];
